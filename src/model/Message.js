    ...
    getViewElement(me = true) {
        ...
        switch (this.type) {
            ...
            case 'image':
                ...
                div.querySelector('.message-photo').on('load', (e)=>{ // quando a foto terminar de carregar
        ...
        // condição pra verificar se a mensagem enviada foi minha ou do outro usuario
        // se tiver algum erro, é em message-time ou msg-time, ou no HTML errado
        ...
        if (me) {
            ...
            // vai colocar a div como irmã de message time
